...
class Mappo:
    def __init__(self, env: Any):
        ...
        self.drone_actor_optim = Adam(self.drone_actor.parameters(), lr=self.learning_rate)
        self.rover_actor_optim = Adam(self.rover_actor.parameters(), lr=self.learning_rate)
